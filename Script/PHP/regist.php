...
if (isset($_POST['submit'])) {
    ...
    $main = mysqli_query($conf, "INSERT INTO tb_dosen (`id`, `nama`, `gender`, `nip`, `nidn`, `golongan_jabatan`, `jabatan_fungsional`, `birthdate`, `tempat`, `email`, `no_hp`, `alamat`, `no_tlp_kantor`, `pendidikanS1`, `pendidikanS2`, `pendidikanS3`, `foto`) VALUES (null,'$name','$gender','$NIP','$NIDN','$class','$position','$birth','$place','$email','$phone','$address','$office','$s1','$s2','$s3','$nama')");
    if ($main) {
