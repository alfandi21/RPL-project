            ...
            <div class="d-flex col align-items-center justify-content-end mx-2 gap-2">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <a href="admin-dashboard.html" class="dropdown-item d-flex align-items-center" href="#">
        ...
        <div class="content d-flex flex-column gap-3 mb-5">
            ...
            <div class="d-flex align-items-center mx-3 mx-md-4 mt-3 mb-2 gap-3">
                <div class="d-flex flex-column justify-content-center">
                    <a title="Dashboard" href="admin-dashboard.html"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content flex-container">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5 text" id="staticBackdropLabel">Change Photo</h1>
                                            <button type="button" class="btn-close bg-light" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <div>
                                                <input class="form-control text-field text" id="formFile" type="file">
                                            </div>
                                        </div>
                                ...
                                <div class="d-flex flex-column gap-3">
                                    <div class="d-flex flex-column">
                                        ...
                                        <input class="form-control bg-body-tertiary" type="text"
                                            value="0123456789101112" aria-label="readonly input example">
                                    </div>
                                    <div class="d-flex flex-column">
                                        <span class="fw-semibold">Name</span>
                                        <input class="form-control bg-body-tertiary" type="text"
                                            value="Placeholder Name" aria-label="readonly input example">
                                    </div>
                                    <div class="d-flex flex-column">
                                        <span class="fw-semibold">Email</span>
                                        <input class="form-control bg-body-tertiary" type="text"
                                            value="email@placeholder.com" aria-label="readonly input example">
                                    </div>
                                    <div class="d-flex flex-column">
                                        <span class="fw-semibold">Birth Date</span>
                                        <input class="form-control bg-body-tertiary" type="text" value="01/01/1990"
                                            id="datepicker" aria-label="readonly input example">
                                    </div>
                                    <div class="d-flex flex-column">
                                        <span class="fw-semibold">Birth Place</span>
                                        <input class="form-control bg-body-tertiary" type="text" value="Birth Place"
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <input class="form-control bg-body-tertiary" type="text" value="08123456789"
                                            aria-label="readonly input example">
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex col flex-column gap-4">
                                ...
                                <div class="d-flex flex-column gap-3">
                                    <div class="d-flex flex-column">
                                        ...
                                        <span class="form-control bg-body-tertiary">Headmaster</span>
                                    </div>
                                    <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <input class="form-control bg-body-tertiary" type="text"
                                            value="Class/Functional" aria-label="readonly input example">
                                    </div>
                                    <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <input class="form-control bg-body-tertiary" type="text" value="Bachelor Degree"
                                            aria-label="readonly input example">
                                    </div>
                                    <div class="d-flex flex-column">
                                        <span class="fw-semibold">Master Degree</span>
                                        <input class="form-control bg-body-tertiary" type="text" value="Master Degree"
                                            aria-label="readonly input example">
                                    </div>
                                    <div class="d-flex flex-column">
                                        <span class="fw-semibold">Doctor Degree</span>
                                        <input class="form-control bg-body-tertiary" type="text" value="Doctor Degree"
                                            aria-label="readonly input example">
                                    </div>
                                </div>
                            </div>
